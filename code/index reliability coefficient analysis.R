...
df <- read.csv(file.choose()) #select the .csv file "combined_poverty_index_2002-2018.csv"
...
df <- read.csv(file.choose()) #select the .csv file "urban_added_combined_population_heterogeneity_index_2002-2018.csv"
